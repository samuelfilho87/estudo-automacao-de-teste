...
describe('Exercício 1 - Multiplos', () => {
  ...
  it('somar multiplos de 3 ou 5 menor que 16', () => {
    ...
    const multiplosDe3 = multiplos.pegarMultiplos(3);
    const multiplosDe5 = multiplos.pegarMultiplos(5);
  ...
  it('somar multiplos de 3 ou 5 e 7 menor que 25', () => {
    multiplos = new Multiplos(25);

    const multiplosDe3 = multiplos.pegarMultiplos(3);
    const multiplosDe5 = multiplos.pegarMultiplos(5);
    const multiplosDe7 = multiplos.pegarMultiplos(7);
